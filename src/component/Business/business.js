...
import DisplayBusin from './DisplayBusin.js';
import ContentLoader, { Facebook } from "react-content-loader";

const businessurl="https://saurav.tech/NewsAPI/top-headlines/category/business/in.json";
class business extends Component{
 ...
 return(
         ...
         <DisplayBusin displaydata={this.state.businessnews}/>
     </React.Fragment>
        )   
    }

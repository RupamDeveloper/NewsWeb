...
import DisplaySport from './DisplaySport.js';

const businessurl="https://saurav.tech/NewsAPI/top-headlines/category/sports/in.json";
class sport extends Component{
    ...
    render(){
        return(
         ...
         <DisplaySport displaydata={this.state.businessnews}/>
     </React.Fragment>
        )   
    }
     componentDidMount(){

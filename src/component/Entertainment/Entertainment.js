...
import DisplayEntertainment from './DisplayEntertain';

const entertainmenturl="https://saurav.tech/NewsAPI/top-headlines/category/entertainment/in.json";
class entertainment extends Component{
    ...
    render(){
        return(
         ...
         <DisplayEntertainment displaydata={this.state.entertainnews}/>
     </React.Fragment>
        )   
    }
     componentDidMount(){
        ...
        .then((res)=>res.json())
        .then((data)=>{
            this.setState({entertainnews:data.articles});

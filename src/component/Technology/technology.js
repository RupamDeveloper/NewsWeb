...
import DisplayTech from './DisplayTech.js';

const businessurl="https://saurav.tech/NewsAPI/top-headlines/category/technology/in.json";
class tech extends Component{
    ...
    render(){
        return(
         ...
         <DisplayTech displaydata={this.state.businessnews}/>
     </React.Fragment>
        )   
    }
     componentDidMount(){
